  ...
  "node_modules/clsx/dist/clsx.js"(exports, module) {
    function r(e3) {
      ...
      if ("string" == typeof e3 || "number" == typeof e3) f += e3;
        ...
        var n = e3.length;
        for (o = 0; o < n; o++) e3[o] && (t = r(e3[o])) && (f && (f += " "), f += t);
      } else for (t in e3) e3[t] && (f && (f += " "), f += t);
      return f;
    }
    function e2() {
      for (var e3, o, t = 0, f = "", n = arguments.length; t < n; t++) (e3 = arguments[t]) && (o = r(e3)) && (f && (f += " "), f += o);
      return f;
    }
  ...
  "node_modules/react-draggable/build/cjs/utils/domFns.js"(exports) {
    ...
    function _interopRequireWildcard(e2, t) {
      ...
      return (_interopRequireWildcard = function(e3, t2) {
        ...
        var o, i2, f = { __proto__: null, default: e3 };
        if (null === e3 || "object" != typeof e3 && "function" != typeof e3) return f;
        if (o = t2 ? n : r) {
          if (o.has(e3)) return o.get(e3);
          o.set(e3, f);
        }
        for (const t3 in e3) "default" !== t3 && {}.hasOwnProperty.call(e3, t3) && ((i2 = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e3, t3)) && (i2.get || i2.set) ? o(f, t3, i2) : f[t3] = e3[t3]);
        return f;
      })(e2, t);
    }
    ...
    function scheduleRemoveUserSelectStyles(doc2) {
      if (window.requestAnimationFrame) {
        window.requestAnimationFrame(() => {
          removeUserSelectStyles(doc2);
        });
      } else {
        removeUserSelectStyles(doc2);
      }
...
function i(i2) {
  ...
  return void 0 !== t ? void 0 !== t.devicePixelRatio ? t.devicePixelRatio : t.screen.deviceXDPI / t.screen.systemXDPI : void 0 !== i2.matchMedia ? function(i3) {
    for (var t2 = i3.matchMedia, o = 10, n = 0.1, r = 1, a = o, c = 0; c < 4; c++) o = (a = 10 * e(t2, o, n, r)) + 9, n = a, r *= 10;
    return a / r;
  }(i2) : 1;
}
